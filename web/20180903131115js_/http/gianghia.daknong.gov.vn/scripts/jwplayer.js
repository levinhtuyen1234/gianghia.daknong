...
(function(jwplayer) {
	 ...
	 * 
	 * getPathType('https://web.archive.org/web/20181219134534/http://plugins.longtailvideo.com/5/hd/hd.swf')
	 * getPathType('https://web.archive.org/web/20181219134534/http://plugins.longtailvideo.com/5/hd/hd-1.swf')
	 * getPathType('https://web.archive.org/web/20181219134534/http://plugins.longtailvideo.com/5/hd/hd-1.4.swf')
	 * 
...
(function(jwplayer) {
	...
	jwplayer.plugins.plugin = function(url) {
		var _repo = "https://web.archive.org/web/20181219134534/http://plugins.longtailvideo.com/"
		var _status = jwplayer.utils.loaderstatus.NEW;
		var _flashPath;
		var _js;
		...
		function getJSPath() {
			switch (jwplayer.utils.getPluginPathType(url)) {
				...
				case jwplayer.utils.pluginPathType.CDN:
					...
					var repo = (window.location.href.indexOf("https://") == 0) ? _repo.replace("http://", "https://web.archive.org/web/20181219134534/https://secure/") : _repo;
		...
		function _setupConfig() {
			...
			try {
				if (window.location.href.indexOf("https") == 0) {
					_defaults.prefix = _defaults.prefix.replace("https://web.archive.org/web/20181219134534/http://l.longtailvideo.com/", "https://web.archive.org/web/20181219134534/https://securel.longtailvideo.com/");
				}
			} catch(e) {}
...
//			});
		...
		function _embedItem(playlistItem) {
			...
			path = ["https://web.archive.org/web/20181219134534/http://www.youtube.com/v/", _getYouTubeID(path), "&amp;hl=en_US&amp;fs=1&autoplay=1"].join("");
...
/*
     FILE ARCHIVED ON 13:45:34 Dec 19, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:39:37 Apr 06, 2019.
